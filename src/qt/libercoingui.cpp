    ...
    platformStyle(_platformStyle)
{
    ...
    frameBlocksLayout->addWidget(blockCount);
    if(enableWallet)
    {
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LIBERCOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and LIBERCOIN: URIs)"));
    ...
    ghostVaultMenuAction = new QAction(platformStyle->TextColorIcon(":/icons/eye"), ghostVaultAction->text(), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LIBERCOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LIBERCOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a LIBERCOIN: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible LIBERCOIN command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to LIBERCOIN network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, bool header)
{
    ...
    */
    ...
    blockCount->setText(tr("Current Block Height: ") + QString::number((count)));
...
void BitcoinGUI::setAdditionalDataSyncProgress(int count, double nSyncProgress)
{
    ...
    if(ghostnodeSync.IsBlockchainSynced())
    {
        ...
        strSyncStatus = QString(ghostnodeSync.GetSyncStatus().c_str());
...
{
    QString strTitle = tr("LIBERCOIN"); // default title
